                ...
                <div className={styles.form_PersonalInfo}>
                    <form>
                        <div>
                            ...
                            <input onChange={clickCheckInputs} ref={this.inputName} type="text" name="name" required placeholder="e.g. Hossein" data-set="name"/>
                            <span>Enter your name</span>
                        </div>
                        <div>
                            <label>Email Address</label>
                            <input onChange={clickCheckInputs} ref={this.inputEmail} data-set="email" type="email" name="email" required placeholder="e.g. hosseinrg@gmail.com"/>
                            <span>Enter your email accurately</span>
                        </div>
                        <div>
                            <label>Phone Number</label>
                            <input onChange={clickCheckInputs}
                            ref={this.inputPhone} data-set="phone" type="tel" name="tel" required placeholder="e.g. 09123331210"/>
