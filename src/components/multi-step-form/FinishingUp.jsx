...
class FinishingUp extends React.Component {
    ...
    calcTotalPrice = () => {
        ...
        this.state.formYearOrMonth
            ? (total += this.formSelectPlanPrice)
            : (total += this.formSelectPlanPrice * 10)
        return total
    }
                ...
                <div className={styles.box_finishingUp}>
                    <div className={styles.box_finishingUp_changePlan}>
                        ...
                        <p>
                            $
                            {this.state.formYearOrMonth
                                ? this.formSelectPlanPrice
                                : this.formSelectPlanPrice * 10}
                            ...
                            if (value) {
                                return (
                                    <div key={i}>
                                        ...
                                        {this.state.formYearOrMonth ? (
                                            <span>{this.dataAddOns[i].mo}</span>
                                        ) : (
                                            <span>{this.dataAddOns[i].yr}</span>
                                        )}
                                    </div>
                                )
                            }
